...
# 27-IBL-With-Material-Texture

&emsp;&emsp;这个示例中，补充完整了 PBR 的材质，最终完整的实现了基于 IBL 和 PBR 材质的完整的示例。

![image-20230414213554440](ScreenShot/27-1.png)

![image-20230414213723381](ScreenShot/27-2.png)

![image-20230414213901500](ScreenShot/27-3.png)
